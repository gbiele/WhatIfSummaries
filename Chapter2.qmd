...
- the assumption can not be verified, but randomization produces exchangeability (more likely with larger sample size)
...
For small N experiments exchangeability is an unverifiable assumptions!
